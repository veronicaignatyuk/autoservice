					...
					<div id="inputs">
						...
						<center>
							<input id="passwordfirst" type="password" name="passwordF"
								placeholder="Password" pattern=".{3,15}" title="3 to 15 symbols"
								required>
						</center>

						<center>
							<input id="passwordsec" type="password" name="passwordS"
								placeholder="Repeat your Password" pattern=".{3,15}"
								title="3 to 15 symbols" required>
						</center>
					</div>
				</fieldset>
										...
										<form action="controller" method="POST">
											<fieldset id="inputs">
												<input id="username" type="email" name="email" value="email"
													...
													pattern=".{3,15}" maxlength=15 minlength=3
